...
public interface DObject {
	...
	/**
	 * Applies a {@link Vector} force on this object at the specified {@link Vector} position
	 * @param force the force applied
	 * @param position the position of the applied force relative to the origin of this DObject
	 */
